                    ...
                    for month in range(1,13):
                        for day in range(1,32):
                            try:
                                ...
                                ref_greg,ref_jul = _testjdn(year,month,day)
                            except RangeError:
                                continue
                            if p:
                                try:
...
def test_pydatetime_integration():
